...
class StockEnvTrade(gym.Env):
    ...
    def _sell_stock(self, index, action):
        ...
        if self.turbulence < self.turbulence_threshold: # 임계치 아래에 있다면
            ...
            # if turbulence goes over threshold, just clear out all positions (임계치 위에 있을 때 다 매도 and 손절)
            if self.state[index+STOCK_DIM+1] > 0:
                #update balance
...
#        if 
    ...
    def step(self, actions):
        ...
        if self.terminal:
            ...
            print("stock_shares:{}".format(self.state[STOCK_DIM+1:STOCK_DIM*2+1]))  # 주식 수 ####
           ...
           # print("stock_shares:{}".format(self.state[STOCK_DIM*2+1]))  # 주식 수 ####
            ...
            #load next state
            #print("stock_shares:{}".format(self.state[29:]))  # 주식 수 ####
